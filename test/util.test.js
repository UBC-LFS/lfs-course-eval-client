...
describe('expandCount', () => {
  it('takes a count object and returns the array', () => {
    ...
    assert.deepEqual(util.expandCount(sampleCount), output)
  })
  it('can handle missing count properties', () => {
    ...
    assert.deepEqual(util.expandCount(sampleCount), [1, 2, 2])
    sampleCount = {
      '5': 100
    }
    assert.deepEqual(util.expandCount(sampleCount), Array(100).fill(5))
  })
})
